...
class Quotes extends CI_Model {
	...
	var $data = array(
		...
		array('id' => '7', 'who' => 'Albus Dumbledore', 'mug' => 'Dumbledore.jpg', 'where' => '/comp4711/wisdom',
			'what' => 'After all, to the well-organized mind, death is but the next great adventure.')
	);
